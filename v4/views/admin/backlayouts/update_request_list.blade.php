                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered"
                                    ...
                                    <tbody>
                                        @foreach ($updateRequestList as $requestList)
                                            <tr>
                                                <td>{{ $requestList->name }}</td>
                                                <td>{{ $requestList->middlename }}</td>
                                                <td>{{ $requestList->lastname }}</td>
                                                <td>{{ $requestList->email}}</td>
                                                <td>{{ $requestList->phone}}</td>
                                                 <td>{{ $requestList->dob}}</td>
                                                  <td>{{ $requestList->approval_status}}</td>
                                                 <td><a href="{{ url('/update_request_list') ."/".$requestList->user_id }}">View/Edit</a></td>
