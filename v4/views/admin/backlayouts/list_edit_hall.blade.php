        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>@if($display_enabled==1) List & Edit Halls @else List of Halls & Rates @endif</h3>
                </div>
                    ...
                    <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                        <nav aria-label="breadcrumb" >
                            <ol class="breadcrumb pull-right" style="background: none">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">List and Edit Halls</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            ...
                            <thead>
                                ...
                                @foreach($roomtypes as $roomtype)
                                    ...
                                    @if(strtolower($role)=='super'||strtolower($role)=='admin')
                                        @if($display_enabled==1)
                                            <td><a href="{{ url('/view_edit_hall/'.$roomtype->id) }}">View/Edit</a></td>
                                            <td><a href="{{ url('/view_edit_hall_services/'.$roomtype->id) }}">View/Edit</a></td>
                                        @endif
                                    @endif
                                    </tr>
                                @endforeach
