                ...
                <div class="row" style="display: block;">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form action="{{ url('/add_room_numbers') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left mt-5">
                                @csrf
                                    @if($role=="super")
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="cust-name">New Room Number<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            ...
                                            <button type="submit" class="btn btn-success" name="add_room_number" value="newroomnumber">Add Room Number</button>
                                        </div>
                                    </div>
