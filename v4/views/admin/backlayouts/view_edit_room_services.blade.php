            ...
            <div class="page-title">
                <div class="title_left">
                    @if($currenturlcheckdisplay==1)
                        <h3>View/Edit {{ $titlename->room_name }} {{ ucfirst($group) }} Services</h3>
                    @endif
                </div>
...
<!--                                <h2>Default Example <small>Users</small></h2>-->
                        ...
                        <div class="x_content">
                            ...
                            @if($currenturlcheckdisplay==1)
                                ...
                                <form action="{{ url('/view_edit_room_services/'.$daomniroomtypes_id) }}" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left mt-5">
                                    @csrf
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                ...
                                                <button type="submit" class="btn btn-success" name="add_room_services" value="@if($daomniroomtypes_id>0) {{ "update_room_services" }} @else  {{ "add_new_room_services" }} @endif">
                                                    @if($daomniroomtypes_id>0) {{ "Update Room Service..." }}@else  {{ "Add New Room Service..." }} @endif</button>
                                            </div>
                                        </div>
                                </form>                            
                                @endif                            
