            ...
            <div class="col-lg-8 col-lg-offset-2 col-xs-12 col-xs-offset-2 mx-auto">
                ...
                <div id="pdfArea">
                    ...
                    <div class="p-3 bg-white">
                        ...
                        <hr>
                        <h2 class="text-orange ">Hi, {{ $bookings['first_name'] }} {{ $bookings['last_name'] }}</h2>
                        <h4>Thank you for staying with us</h4>
                        <p>You chose {{ join('',explode('600',join('',explode('500',join('',explode('450',$bookings['selectedplot'])))))) }} @if(strtolower($selectedplot_detail->page_name)=='houses'||strtolower($selectedplot_detail->page_name)=='house') House @endif
                        ...
                        <div class="card">
                            <div class="card-header font-weight-bold text-center">
                                Transaction Reference : {{ "No Payment Yet" }} 
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <div class="bg-secondary p-4 text-center text-white">
                                            <h1 class="pb-0 mb-0">&#x20A6;{{ number_format($bookings['payamount'],2,".",",") }}</h1>
                                            <p class="py-0 my-0">@if($bookings['paymentmethod']=='installments') {{ 'First instalment to pay at office' }} @endif
                                            @if($bookings['paymentmethod']=='outright') Outright Payment @endif
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-sm" style="background-image: url({{ asset('frontend/images/thronehomes_fade.png') }}); background-size: 100%" width="100%">
                                        <tr>
                                            <td style="border: none;">
                                                ...
                                                <p class="mb-0">{{ $bookings['emailaddress'] }}</p>
                                            </td>
                                            <td style="border: none;">
                                                <p class="font-weight-bold pb-0 mb-0">Applicant's Phone</p>
                                                <p class="mb-0">{{ $bookings['phonenumber'] }}</p>
                                            </td>
                                            <td style="border: none;">
                                        ...
                                        <tr>
                                            <td style="border: none;">
                                                ...
                                                <p class="mb-0"> @if($orderdetailsprocessed->status=='standby') Pay at Office @endif</p>
                                            </td>
                                            <td style="border: none;">
