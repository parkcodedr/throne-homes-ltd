      ...
      <div class="slider">
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
          <ul>
            ...
            <!-- SLIDE NR. 1 -->
            @if($slider->content_id==1)
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="{{ asset($slider->slider_img) }}" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <h1
              ...
              <div
                ...
                style="z-index: 11;">
                <a class="btn" href="{{ url($slider->slider_caption_link) }}">
                  <i class="fa fa-paper-plane"></i>{{ $slider->slider_caption_link_label }}</a>
              </div>
              <!-- LAYER NR. 4 -->
              <div
                class="tp-caption"
                ...
                data-frames='[{"delay":2400,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                style="z-index: 11;">
                <a class="btn" href="{{ url($slider->slider_last_link_1) }}">
                  <i class="fa fa-envelope-o" aria-hidden="true"></i>{{ $slider->slider_last_label_1 }}</a>
              </div>
              <!-- LAYER NR. 5 -->
              ...
              <div
                ...
                style="color: #fff">
                  {{ $slider->slider_last_label_2 }}
              </div>
            </li>
            @endif

            <!-- SLIDE NR. 2 -->
            @if($slider->content_id==2)
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="{{ asset($slider->slider_img) }}" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <div
                ...
                data-whitespace="nowrap"
                data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                style="z-index: 5; color: #fff; font-weight: 900;">{{ $slider->slider_caption }}
              </div>
              <!-- LAYER NR. 2 -->
              <div
                class="tp-caption tp-resizeme"
                ...
                style="z-index: 6; color: #fff;">{{ $slider->slider_caption_link_label }}
              </div>
                <!-- LAYER NR. 3 -->
                <div
                        class="tp-caption"
                        ...
                        style="z-index: 11;">
                    <a class="btn" href="{{ url($slider->slider_last_link_1) }}">
                        <i class="fa fa-paper-plane"></i>{{ $slider->slider_last_label_1 }}</a>
                </div>
                <!-- LAYER NR. 4 -->
                <div
                        class="tp-caption"
                        ...
                        data-frames='[{"delay":2400,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                        style="z-index: 11;">
                    <a class="btn" href="{{ url($slider->slider_last_link_2) }}">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>{{ $slider->slider_last_label_2 }}</a>
                </div>
            </li>
            @endif
        ...
        <!-- start slider -->
          @include('home.frontlayouts.slider_booking_form')
        <!-- end slider -->