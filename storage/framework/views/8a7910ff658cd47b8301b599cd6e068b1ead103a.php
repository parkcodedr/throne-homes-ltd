<div class="container body">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 ">
              <div class="x_panel tile fixed_height_320">
                <div class="x_title">
                  <h2>Wallet Balance / Usage Meter</h2>
                ...
                <div class="x_content">
                  <a href="<?php echo e(url('/wallet_history')); ?>"><h4>Current Balance : </h4><br><b> <h1>N <?php echo e(number_format($walletbalance, 2, '.', ',')); ?> K</h1></b></a><br><br>
                  <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                      <div class="progress">
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e(($walletbalance/$walletlimit)*100); ?>%;">
                          <span class="sr-only">60% Complete</span>
                        </div>
                      </div>
                    </div>
                    <div class="w_right w_20">
                      <span><?php echo e($walletbalance/1000); ?>k</span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <i><b>NB: your current wallet limit is N<?php echo e(number_format($walletlimit, 2, '.', ',')); ?> K </b></i>
                </div>
              </div>
            </div>
    ...
    </div><?php /**PATH /home/thronehomesltd/public_html/homes/homes/resources/views/admin/backlayouts/main_main.blade.php ENDPATH**/ ?>