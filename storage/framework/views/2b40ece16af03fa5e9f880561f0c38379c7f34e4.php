...
<div class="wrapper">
            ...
            <div class="col-lg-8 col-lg-offset-2 col-xs-12 col-xs-offset-2 mx-auto">
                ...
                <div id="pdfArea">
                    ...
                    <div class="p-3 bg-white">
                        ...
                        <hr>
                        <h2 class="text-orange ">Hi, <?php echo e($bookings['firstname']); ?> <?php echo e($bookings['lastname']); ?></h2>
                        <h4>Thank you for staying with us</h4>
                        <p>You chose <?php echo e(join('',explode('600',join('',explode('500',join('',explode('450',$selectedplot_detail->lands_name))))))); ?> <?php if(strtolower($selectedplot_detail->page_name)=='houses'||strtolower($selectedplot_detail->page_name)=='house'): ?> House <?php endif; ?>
                        ...
                        <div class="card">
                            <div class="card-header font-weight-bold text-center">
                                Transaction Reference : <?php echo e($message); ?>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <div class="bg-secondary p-4 text-center text-white">
                                            <h1 class="pb-0 mb-0">&#x20A6;<?php echo e(number_format($bookings['price_pay'],2,".",",")); ?></h1>
                                    ...
                                    <table class="table table-sm" style="background-image: url(<?php echo e(asset('frontend/images/thronehomes_fade.png')); ?>); background-size: 100%" width="100%">
                                        <tr>
                                            <td style="border: none;">
                                                ...
                                                <p class="mb-0"><?php echo e($bookings['email']); ?></p>
                                            </td>
                                            <td style="border: none;">
                                                <p class="font-weight-bold pb-0 mb-0">Applicant's Phone</p>
                                                <p class="mb-0"><?php echo e($bookings['phone']); ?></p>
                                            </td>
                                            <td style="border: none;">
                                        ...
                                        <tr>
                                            <td style="border: none;">
                                                ...
                                                <p class="mb-0"> <?php if($bookings['status']=='standby'): ?> Pay at Office <?php endif; ?> <?php if($bookings['status']=='confirmed' && !empty($bookings['transaction_reference'])): ?> <?php echo e(ucfirst(strtolower($bookings['payment_plan']))); ?> Payment <?php endif; ?></p>
                                            </td>
                                            <td style="border: none;">
    ...
    </section><?php /**PATH C:\laragon\www\thronehomesltd\resources\views/home/frontlayouts/receipt_receipt_main.blade.php ENDPATH**/ ?>