                        ...
                        <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb pull-right" style="background: none">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">House's Subscription</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<?php /**PATH C:\laravel\thronehomesltd\resources\views/admin/backlayouts/housesub.blade.php ENDPATH**/ ?>