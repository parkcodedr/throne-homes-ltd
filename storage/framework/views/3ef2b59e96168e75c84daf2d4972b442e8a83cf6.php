...
<div class="wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-12">
                    ...
                    <!-- BOOKING FORM -->
                    <form method="post" action="<?php echo e(route('confirmorder')); ?>" enctype="multipart/form-data" autocomplete="off">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="firstname" type="text" class="form-control" value="<?php echo e(explode(' ',Request::get('name'))[0]); ?>" placeholder="First Name" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-dark">Last Name</label>
                                    <input name="lastname" type="text" class="form-control" placeholder=" Last Name" value="<?php echo e(str_replace(explode(' ', Request::get('name'))[0], ' ', Request::get('name'))); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="othername" type="text" class="form-control" placeholder="Other Name" value="<?php echo e(Request::get('othername')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-dark">Date of Birth (dd/mm/yyyy) </label>
                                    <input name="dob" type="date" class="form-control" placeholder=" Date of Birth" value="<?php echo e(Request::get('dob')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input name="phone" type="text" class="form-control" value="<?php echo e(Request::get('phone_number')); ?>" placeholder="Your Phone Number" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark" for="">contact Address</label>
                                    <input class="form-control" name="address" placeholder="contact Address" value="<?php echo e(Request::get('adddress')); ?>" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">Email Address</label>
                                    <input class="form-control" name="email" type="email" value="<?php echo e(Request::get('email')); ?>" placeholder="Your Email Address" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="employer" type="text" placeholder="Your Employer Name" value="<?php echo e(Request::get('employer')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="office" type="text" placeholder="Office Address" value="<?php echo e(Request::get('office')); ?>"  required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-dark">City/Country</label>
                                    <input class="form-control" name="city" type="text" placeholder="City/Country" value="<?php echo e(Request::get('city')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="id_card" type="text" placeholder="ID Card Number" value="<?php echo e(Request::get('id_card')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 text-center" style="margin-bottom: 10px" >
                                <div style="display: block; margin: auto;">
                                    ...
                                    <div class="col" style="display: block;  margin: auto;">
                                        <img src="<?php echo e(asset('/backend/images/placeholder.png')); ?>" style="text-align: center;" id="passport-preview" height="100px" width="100px" alt="">
                                    </div>
                            ...
                            <div class="col-md-6 text-center" style="margin-bottom: 10px" >
                                <div style="display: block; margin: auto;">
                                    ...
                                    <div class="col" style="display: block;  margin: auto;">
                                        <img src="<?php echo e(asset('/backend/images/placeholder.png')); ?>" style="text-align: center;" id="idphoto-preview" height="100px" width="100px" alt="">
                                    </div>
                                </div>
                                <div class="custom-file" style="margin-top: 5px">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input name="kin_name" type="text" class="form-control" value="<?php echo e(Request::get('kin_name')); ?>"  placeholder="Full Name" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-dark">Relationship</label>
                                    <input name="relationship" type="text" class="form-control" value="<?php echo e(Request::get('relationship')); ?>"  placeholder="Relationship" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">Phone Number</label>
                                    <input name="kin_phone" type="text" class="form-control" value="<?php echo e(Request::get('kin_phone')); ?>"  placeholder="Phone Number" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">Email Address</label>
                                    <input class="form-control" name="kin_email" type="email" value="<?php echo e(Request::get('kin_email')); ?>" placeholder="Email Address" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label class="text-dark" for="">contact Address</label>
                                    <input class="form-control" name="kin_address" placeholder="contact Address" value="<?php echo e(Request::get('kin_address')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-dark">City/Country</label>
                                    <input class="form-control" name="kin_city" type="text" placeholder="City/Country" value="<?php echo e(Request::get('kin_city')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="preferred_location" type="text" value="<?php echo e(Request::get('preferred_location')); ?>" placeholder="Preferred Location" required>
                                </div>
                            </div> 
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">Plot Size/NUMBER OF UNIT(S)</label>
                                    <input class="form-control" name="plot" type="text" value="<?php echo e(Request::get('plot')); ?>" placeholder="Plot Size" required>
                                </div>
                            </div> 
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="text-dark">Agent Name/Agent Code</label>
                                    <input class="form-control" name="agent" type="text" value="<?php echo e(Request::get('agent')); ?>" placeholder="Enter Agent Name/Agent Code" required>
                                </div>
                            </div> 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="plothouse" name="plot" class="form-control">
                                        ...
                                        <?php if(Request::get('location') !== null): ?>
                                        <?php if(str_contains(strtolower($land->lands_name), strtolower(Request::get('location')))): ?>
                                        <option value="<?php echo e($land->id); ?>" data-value="<?php echo e($land->lands_price); ?>" data-name="<?php echo e($land->lands_name); ?>">
                                            <?php echo e($land->lands_name); ?>
                ...
                <div class="col-lg-3 col-12">
                    <div class="sidebar">
                        <div class="contact-details">
                            ...
                            <?php if($land->content_id==1): ?>
                            <div class="section-title">
                                <h4><?php echo e(strtoupper($land->land_detail_others)); ?></h4>
                                <p class="section-subtitle"><?php echo e(strtoupper($land->land_detail_available_info)); ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="offer-item sm mb50">
                                <figure class="gradient-overlay-hover link-icon">
                                    <a href="<?php echo e(url($land->land_details_link.'/'.$land->id)); ?>">
                                        <img src="<?php echo e(url($land->lands_img)); ?>" class="img-fluid" alt="Image">
                                    </a>
                                </figure>
                                <div class="ribbon">
                                    <span><?php echo e($land->lands_location); ?></span>
                                </div>
                                <div class="offer-price uppercase">
                                    <?php echo e(join('',explode('600',join('',explode('500',join('',explode('450',$land->lands_details))))))); ?> N<?php echo e(number_format($land->lands_price/1000000,1,".",",")); ?>M
                                </div>
                            ...
                            <div class="offer-item sm mb50">
                                ...
                                <div class="offer-price uppercase">
                                    <?php echo e(join('',explode('600',join('',explode('500',join('',explode('450',$land->lands_details))))))); ?> N<?php echo e(join('',explode('.0',join('',explode('.00',number_format($land->lands_price/1000000,1,".",",")))))); ?>M
                                </div>
                                <h3 class="offer-title">
                                    <a href="" <?php echo e(url($land->lands_details_link.'/'.$land->id)); ?>"><?php echo e(join('',explode('600',join('',explode('500',join('',explode('450',$land->lands_name))))))); ?></a>
                                </h3>
    ...
    <script src="<?php echo e(asset('js/orderform.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
    <?php $__env->startPush('scripts'); ?>
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('home.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thronehomesltd/public_html/homes/homes/resources/views/home/order_form.blade.php ENDPATH**/ ?>