...
<div class="wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-12">
                    ...
                    <!-- BOOKING FORM -->
                    <form method="post" action="<?php echo e(route('confirmagentreg')); ?>" enctype="multipart/form-data" autocomplete="off">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('home.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thronehomesltd\resources\views/home/agent_form.blade.php ENDPATH**/ ?>