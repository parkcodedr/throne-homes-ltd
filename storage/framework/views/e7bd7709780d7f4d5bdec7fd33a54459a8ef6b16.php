                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered"
                                    ...
                                    <tbody>
                                    <?php if(count($houseSubscription)==0): ?>
                                    <tr>
                                    <td colspan="5" class="text-center">No record found </td>
                                    </tr>
                                    <?php else: ?>
                                   
                                        <?php $__currentLoopData = $houseSubscription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $land): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
...
<?php /**PATH C:\laravel\thronehomesltd\resources\views/admin/backlayouts/house_subscription.blade.php ENDPATH**/ ?>