                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <form action="<?php echo e(route('upload_payment')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laravel\thronehomesltd\resources\views/admin/backlayouts/upload_payment_doc.blade.php ENDPATH**/ ?>