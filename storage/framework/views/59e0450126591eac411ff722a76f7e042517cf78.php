                        ...
                        <div class="col-md-6 col-sm-6   form-group pull-right top_search">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb pull-right" style="background: none">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('/home')); ?>">House</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add New House Project</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row" style="display: block;">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form action="<?php echo e(url('/save_house')); ?>" method="POST" id="demo-form2" enctype="multipart/form-data"
...
<?php /**PATH /home/thronehomesltd/public_html/homes/homes/resources/views/admin/backlayouts/add_house.blade.php ENDPATH**/ ?>